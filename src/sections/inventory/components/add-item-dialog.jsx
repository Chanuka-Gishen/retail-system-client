    ...
    >
      ...
      <Formik
        initialValues={{
          ...
          itemBuyingPrice: 0,
          itemSellingPrice: 0,
          itemWholesalePrice: 0,
          itemWholesaleThreshold: 10,
          itemSupplier: '',
          itemThreshold: 5,
        }}
          ...
          <form onSubmit={handleSubmit}>
            <DialogContent>
              <Grid container spacing={2} sx={{ mt: 1 }}>
                ...
                <Grid size={{ xs: 12, sm: 12, lg: 6 }}>
                  <FormControl fullWidth>
                    ...
                    <Select
                      ...
                      onBlur={handleBlur}
                      disabled={isLoadingCategoriesSelection}
                    >
                ...
                <Grid size={{ xs: 12, sm: 6, lg: 6 }}>
                  <TextField
                    label="Item Wholesale Price"
                    name="itemWholesalePrice"
                    fullWidth
                    required
                    autoComplete="off"
                    variant="outlined"
                    {...getFieldProps('itemWholesalePrice')}
                    error={touched.itemWholesalePrice && Boolean(errors.itemWholesalePrice)}
                    helperText={touched.itemWholesalePrice && errors.itemWholesalePrice}
                    slotProps={{ input: { inputComponent: CurrencyInput } }}
                  />
                </Grid>
                <Grid size={{ xs: 12, sm: 6, lg: 6 }}>
                  <TextField
                    label="Item Wholesale Threshold"
                    name="itemWholesaleThreshold"
                    fullWidth
                    required
                    type="number"
                    autoComplete="off"
                    variant="outlined"
                    {...getFieldProps('itemWholesaleThreshold')}
                    error={touched.itemWholesaleThreshold && Boolean(errors.itemWholesaleThreshold)}
                    helperText={touched.itemWholesaleThreshold && errors.itemWholesaleThreshold}
                  />
                </Grid>
              </Grid>
            </DialogContent>
